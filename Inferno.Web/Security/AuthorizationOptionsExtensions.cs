...
public static class AuthorizationOptionsExtensions
{
    ...
    /// </summary>
    public static void AddPermission(this AuthorizationOptions options, string policyName, string claimValue) => options.AddPolicy(policyName, policy => policy.RequireAssertion(ctx =>
