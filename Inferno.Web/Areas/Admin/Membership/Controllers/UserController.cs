...
public class UserController : ExportController<InfernoUser>
{
    ...
    [HttpGet("export/csv")]
    public async Task<FileResult> ExportToCsv() => await Export(DownloadFileFormat.Delimited);

    [HttpGet("export/excel")]
    public async Task<FileResult> ExportToExcel() => await Export(DownloadFileFormat.XLSX);
