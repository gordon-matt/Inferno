...
internal class PropertyHelper
{
    ...
    /// </summary>
    public Func<object, object> ValueGetter => field ??= MakeFastPropertyGetter(Property);

    /// <summary>
    /// Gets the property value setter.
    /// </summary>
    public Action<object, object> ValueSetter => field ??= MakeFastPropertySetter(Property);
    ...
    /// </returns>
    public static PropertyHelper[] GetVisibleProperties(TypeInfo typeInfo) => GetVisibleProperties(typeInfo.AsType(), CreateInstance, PropertiesCache, VisiblePropertiesCache);
    ...
    /// A cached array of all public properties of the specified type.
    /// </returns>
    public static PropertyHelper[] GetVisibleProperties(Type type) => GetVisibleProperties(type, CreateInstance, PropertiesCache, VisiblePropertiesCache);
