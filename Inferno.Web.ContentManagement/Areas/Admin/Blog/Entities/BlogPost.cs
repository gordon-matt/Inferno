...
namespace Inferno.Web.ContentManagement.Areas.Admin.Blog.Entities
{
    ...
    public class PostMap : InfernoEntityTypeConfiguration<BlogPost>
    {
        public override void Configure(EntityTypeBuilder<BlogPost> builder)
        {
            builder.ToTable(CmsConstants.Tables.BlogPosts, InfernoSchema);
            ...
            //    m.MapLeftKey("PostId");
            //    m.MapRightKey("TagId");
            //    m.builder.ToTable("Inferno_BlogPostTags");
            //});
