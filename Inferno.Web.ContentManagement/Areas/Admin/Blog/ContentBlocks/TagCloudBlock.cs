...
namespace Inferno.Web.ContentManagement.Areas.Admin.Blog.ContentBlocks
{
    public class TagCloudBlock : ContentBlockBase
    {
        ...
        ///// </summary>
        //[LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.Width)]
        //public short Width { get; set; }

        //[LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.WidthUnit)]
        //public CssUnit WidthUnit { get; set; }

        ///// <summary>
        ///// Fixed height of the container, will default to container current height.
        ///// </summary>
        //[LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.Height)]
        //public short Height { get; set; }

        //[LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.HeightUnit)]
        //public CssUnit HeightUnit { get; set; }

        ///// <summary>
        ///// Position of the center of the cloud relatively to the container.
        ///// </summary>
        //[LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.CenterX)]
        //public float CenterX { get; set; }

        ///// <summary>
        ///// Position of the center of the cloud relatively to the container.
        ///// </summary>
        //[LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.CenterY)]
        //public float CenterY { get; set; }

        /// <summary>
        /// If the container has dynamic dimensions, set this option to true to update the cloud when the window is resized.
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.AutoResize)]
        public bool AutoResize { get; set; }

        /// <summary>
        /// Number of "steps" to map the words on, depending on their weight (see Colors & sizes section).
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.Steps)]
        ...
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.ClassPattern)]
        ...
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.AfterCloudRender)]
        ...
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.Delay)]
        public byte? Delay { get; set; }

        /// <summary>
        /// Cloud shape
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.Shape)]
        public CloudShape Shape { get; set; }

        /// <summary>
        /// Don't render words which would overflow the container.
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.RemoveOverflowing)]
        public bool RemoveOverflowing { get; set; }

        /// <summary>
        /// Encode special characters in words link.
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.EncodeURI)]
        public bool EncodeURI { get; set; }

        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.Colors)]
        public string Colors { get; set; }

        /// <summary>
        /// Expressed in fraction of container width
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.FontSizeFrom)]
        public float? FontSizeFrom { get; set; }

        /// <summary>
        /// Expressed in fraction of container width
        /// </summary>
        [LocalizedDisplayName(InfernoCmsLocalizableStrings.ContentBlocks.TagCloudBlock.FontSizeTo)]
