...
public partial class AddBasicFrameworkTables : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Inferno_Languages", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Inferno_LocalizableProperties", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Inferno_LocalizableStrings", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Inferno_ScheduledTasks", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Inferno_Settings", x => x.Id));
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_Inferno_Tenants", x => x.Id));
